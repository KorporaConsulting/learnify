<?php
$this->load->view('guru/template_guru/header');
$this->load->view('guru/template_guru/sidebar');
?>
<!-- Main Content -->
        ...
        <div class="">
            <div class="card" style="width:100%;">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('guru/add_materi') ?>" class="btn btn-success">Tambah Materi ⭢</a>
                </div>
            </div>
        </div>
        <div class="">
            <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/guru.jpg">
                <div class=" hero-inner">
                    <h1>Selamat Datang, <?php echo $this->session->userdata('nama'); ?>!</h1>
                    <p class="lead">Anda dapat melihat data siswa disini</p>
                    <div class="mt-4">
                        <a href="<?= base_url('guru/data_siswa') ?>" class="btn btn-outline-white btn-lg btn-icon icon-left"><i class="far fa-user"></i>
                            Data User</a>
                    </div>
                </div>
            </div>
...
<?php
$this->load->view('guru/template_guru/footer');
?>