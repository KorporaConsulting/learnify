    ...
    <div class="row mt-1">
        <div class="col-md-12">
            <div class="card shadow bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="400" style="width: 100%; border-radius:20px;">
                <div class="row" style="color: black; font-family: 'poppins';">
                    <div class="col-md-12 mt-1 text-center">
                        <img class="rounded-circle" width="100px" alt="100x100" src="<?= base_url('assets/profile_picture/' . $profile->image_guru) ?>" data-holder-rendered="true">
                        <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="400"> </h1>
                        <h5><?= $profile->nama_guru ?></h5>
                    </div>
                </div>
            </div>
            <div class="card mt-2 mb-2 shadow bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="400" style="width: 100%; border-radius:20px;">
                ...
                <form action="<?= base_url('mentor/image_profile') ?>" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file" id="profile" required class="custom-file-input" name="image_guru" accept="image/*" id="customFileLang" lang=in">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-12 mb-2 d-flex justify-content-center">
                    <div class="card shadow bg-white mx-auto p-4 buat-text" style="width: 100%; border-radius:20px;">
                        <form action="<?= base_url('mentor/update_profile') ?>" method="post">
                            <div class="form-group">
                                <label for="">NIM</label>
                                <input type="text" class="form-control" readonly required name="nis" value="<?= $profile->nip ?>" id="nis" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">Nama Lengkap</label>
                                <input type="text" class="form-control" required name="nama_guru" value="<?= $profile->nama_guru ?>" id="nama" placeholder="">
                            </div>
                            <div class="form-group">
