                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?= base_url('mentor') ?>">Beranda</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="<?= base_url('mentor/jadwal') ?>">Live Kelas</a>
                            </li>
                            <!-- <li class="nav-item"><a class="nav-link" href="<?= base_url('user/penilaian') ?>">Penil?aian</a> -->
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
                                    Hai, <?php echo $this->session->userdata('nama_guru'); ?> <i class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
